...
// Strings returns list of string divide by given delimiter.
...
// Float64s returns list of float64 divide by given delimiter.
...
// Ints returns list of int divide by given delimiter.
...
// Int64s returns list of int64 divide by given delimiter.
...
// Uints returns list of uint divide by given delimiter.
...
// Uint64s returns list of uint64 divide by given delimiter.
...
// TimesFormat parses with given format and returns list of time.Time divide by given delimiter.
...
// Times parses with RFC3339 format and returns list of time.Time divide by given delimiter.
